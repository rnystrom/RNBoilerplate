...
@protocol PF_FBPlacePickerDelegate;

/*!
 @class PF_FBPlacePickerViewController
 
 @abstract
 The `PF_FBPlacePickerViewController` class creates a controller object that manages 
 the user interface for displaying and selecting nearby places.
 
 @discussion
 When the `PF_FBPlacePickerViewController` view loads it creates a `UITableView` object 
 ...
 The `delegate` property may be set to an object that conforms to the <PF_FBPlacePickerDelegate>
 ...
 picker.
 */
@interface PF_FBPlacePickerViewController : PF_FBViewController
...
/*!
  ...
  */
@property (nonatomic, retain, readonly) id<PF_FBGraphPlace> selection;
...
/*!
 ...
 `PF_FBPlacePickerViewController` object.
 
 @discussion
 An `PF_FBCacheDescriptor` object may be used to pre-fetch data before it is used by
 the view controller. It may also be used to configure the `PF_FBPlacePickerViewController` 
 object.
 ...
 */
+ (PF_FBCacheDescriptor*)cacheDescriptorWithLocationCoordinate:(CLLocationCoordinate2D)locationCoordinate
...
/*!
 ...
 @abstract
 The `PF_FBPlacePickerDelegate` protocol defines the methods used to receive event 
 notifications and allow for deeper control of the <PF_FBPlacePickerViewController>
 view.
 */
@protocol PF_FBPlacePickerDelegate <PF_FBViewControllerDelegate>
@optional
...
/*!
 ...
 @discussion
 The <PF_FBPlacePickerViewController> object's `tableView` property is automatically 
 ...
 */
- (void)placePickerViewControllerDataDidChange:(PF_FBPlacePickerViewController *)placePicker;
 ...
 */
- (void)placePickerViewControllerSelectionDidChange:(PF_FBPlacePickerViewController *)placePicker;
...
/*!
 ...
 @param place               An <PF_FBGraphPlace> object representing the place.
 */
- (BOOL)placePickerViewController:(PF_FBPlacePickerViewController *)placePicker
               shouldIncludePlace:(id <PF_FBGraphPlace>)place;
 ...
 */
- (void)placePickerViewController:(PF_FBPlacePickerViewController *)placePicker
