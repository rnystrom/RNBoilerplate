...
/*! 
 ...
 @unsorted
 */
@interface PF_FBLogger : NSObject

// Access current accumulated contents of the logger.
@property (copy, nonatomic) NSString *contents;

// Each PF_FBLogger gets a unique serial number to allow the client to log these numbers and, for instance, correlation of Request/Response
@property (nonatomic, readonly) NSUInteger loggerSerialNumber;

// The logging behavior of this logger.  See the PF_FB_LOG_BEHAVIOR* constants in PF_FBSession.h 
