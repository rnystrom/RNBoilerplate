...
@class PF_FBViewController;

/*!
 @typedef PF_FBModalCompletionHandler
 
 @abstract
 A block that is passed to [PF_FBViewController presentModallyInViewController:animated:handler:]
 ...
 @param sender          The <PF_FBViewController> that is being dismissed.
 
 @param donePressed     If YES, Done was pressed. If NO, Cancel was pressed.
 */
typedef void (^PF_FBModalCompletionHandler)(PF_FBViewController *sender, BOOL donePressed);

/*!
 @protocol 
 
 @abstract
 The `PF_FBViewControllerDelegate` protocol defines the methods called when the Cancel or Done
 buttons are pressed in a <PF_FBViewController>.
 */
@protocol PF_FBViewControllerDelegate <NSObject>

@optional

/*!
 @abstract
 Called when the Cancel button is pressed on a modally-presented <PF_FBViewController>.
...
/*!
 @abstract
 Called when the Done button is pressed on a modally-presented <PF_FBViewController>.
...
/*!
 ...
 @abstract
 The `PF_FBViewController` class is a base class encapsulating functionality common to several
 ...
 */
@interface PF_FBViewController : UIViewController
 ...
 */
@property (nonatomic, assign) IBOutlet id<PF_FBViewControllerDelegate> delegate;
...
- (void)presentModallyFromViewController:(UIViewController*)viewController
                                animated:(BOOL)animated
                                 handler:(PF_FBModalCompletionHandler)handler;
